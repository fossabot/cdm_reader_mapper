...
generic_regexs["upto4dig"] = r"^\d{1,4}$"
generic_regexs["upto5dig"] = r"^\d{1,5}$"
generic_regexs["upto6dig"] = r"^\d{1,6}$"
generic_regexs["upto7dig"] = r"^\d{1,7}$"
generic_regexs["form_name"] = "^[A-Z]{4,9}$"
generic_regexs["form_call"] = [
    r"^\d[A-Z][A-Z]$",
    r"^(?=.*\d?)(?=.*[A-A])[0-9A-Z]{4,4}$",
    r"^[A-Z]\d[A-Z]\d",
    r"^[A-Z]\d\d[A-Z]$",
...
generic_regexs["form_generic"] = form_generic
generic_regexs["form_cman"] = r"^[A-Z]{4,4}\d$"
ship_names = ["^" + x + "$" for x in ship_names]
generic_regexs["ship_names"] = ship_names
